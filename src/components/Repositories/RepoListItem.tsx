...
const RepoListItem = ({ repoItem }: RepoListItemProps): JSX.Element => {
  return (
    <li className="flex w-full justify-between items-start first:pt-0 py-6 border-b last:border-none border-gray-250 dark:border-gray-600">
      ...
      <button className="flex items-center px-3 py-1 bg-gray-200 dark:bg-gray-600 hover:bg-gray-100 dark:hover:bg-gray-300 border border-gray-250 dark:border-gray-300 hover:border-gray-400 rounded-md outline-none duration-default">
        <StarIcon className="w-4 h-4 mr-1 text-gray-400" />
        <span className="text-gray-400 dark:text-gray-500 text-sm leading-4">Star</span>
      </button>
    </li>
  )
}
